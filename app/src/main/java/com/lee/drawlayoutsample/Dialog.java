...
public class Dialog {
    ...
    public static boolean showComfirmDialog(Activity context, String title,String msg) {
        ...
        return new Dialog(context, title,msg).getResult() == 1;
    }

    public Dialog(Activity context, String title,String msg) {
        //显示Dialog;
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(context);
        dialogBuilder.setPositiveButton("Yes", new DialogButtonOnClick(1));
        dialogBuilder.setNegativeButton("NO", new DialogButtonOnClick(0));
